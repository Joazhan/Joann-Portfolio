    ...
    <main className="min-h-screen bg-white">
      ...
      <section style={{ padding: '80px 40px', display: 'flex', justifyContent: 'center' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', maxWidth: '900px', width: '100%', gridAutoRows: '320px' }}>
          <Image src="/RHS/store_image.avif" alt="User journey map" width={0} height={0} sizes="50vw" style={{ width: '100%', height: '100%', objectFit: 'contain', borderRadius: '0px', display: 'block' }} />
          <Image src="/RHS/pricing_image.avif" alt="Competitor pricing" width={0} height={0} sizes="50vw" style={{ width: '100%', height: '100%', objectFit: 'contain', borderRadius: '0px', display: 'block' }} />
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#f9fafb', padding: '80px 40px' }}>
        <div className="content">
          ...
          <p style={{ fontSize: '16px', lineHeight: '24px', color: 'rgba(0, 0, 0, 0.5)', fontStyle: 'italic', textAlign: 'center', marginBottom: '12px' }}>
