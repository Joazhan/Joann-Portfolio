...
export default function RHS() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <div style={{ backgroundColor: '#f1f5f9', paddingTop: '120px', paddingBottom: '0px', display: 'flex', justifyContent: 'center', alignItems: 'flex-end', overflow: 'hidden', paddingLeft: '48px', paddingRight: '48px' }}>
        <Image
        ...
        <div className="content-wide" style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '80px', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            <div>
              ...
              <p style={{ fontSize: '15px', color: '#626262', lineHeight: '1.8' }}>Product Designer</p>
            </div>
            <div>
              <p className={`section-label ${syne.className}`}>Project Timeline</p>
              <p style={{ fontSize: '15px', color: '#626262' }}>January – February 2023</p>
            </div>
            <div>
              <p className={`section-label ${syne.className}`}>Role</p>
              <p style={{ fontSize: '15px', color: '#626262', lineHeight: '1.8' }}>User Research<br />Wireframing<br />User Testing</p>
            </div>
            <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
            {[
              ...
              <div key={title} className="feature-card">
                <p style={{ fontSize: '15px', fontWeight: '600', color: '#212121', marginBottom: '8px' }}>{title}</p>
      ...
      <section style={{ backgroundColor: '#f9fafb', padding: '80px 40px' }}>
        <div className="content">
          ...
          <div className="img-placeholder" style={{ minHeight: '280px', marginBottom: '16px' }}>
            [ Image: Comparison of long-term loyal and short-term customers ]
          </div>
      ...
      <section style={{ backgroundColor: '#f9fafb', padding: '80px 40px' }}>
        <div className="content">
          ...
          <div className="img-placeholder" style={{ minHeight: '300px', marginBottom: '16px' }}>
            [ Image: Paper wireframe flow for the front page ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center' }}>
        ...
        <div className="content">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '48px' }}>
            <div className="feature-card">
              <p style={{ fontSize: '15px', fontWeight: '600', color: '#212121', marginBottom: '8px' }}>Appointment Selection</p>
              <p style={{ fontSize: '14px', lineHeight: '22px', color: '#6b7280' }}>Clear and straightforward view of available date and time.</p>
            </div>
            <div className="feature-card">
