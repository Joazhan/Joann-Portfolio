    ...
    <main className="min-h-screen" style={{ backgroundColor: '#121212', color: '#ffffff' }}>
      ...
      <div className={`nav-wrapper${navVisible ? '' : ' hidden'}`}>
        <nav className="flex items-center justify-between px-6 py-3 w-full"
          ...
          <div className="flex items-center gap-6">
            <Link href="/" style={{ fontSize: '14px', lineHeight: '18px', color: '#9ca3af' }} className="hover:text-white">Work</Link>
            <Link href="/about" style={{ fontSize: '14px', lineHeight: '18px', color: '#9ca3af' }} className="hover:text-white">About</Link>
            <a href="https://drive.google.com/file/d/10qr8SW-5Bl4sMWUW6xxBK6LH0Zkw3B1w/view?usp=sharing" target="_blank" rel="noopener noreferrer" style={{ fontSize: '14px', lineHeight: '18px', color: '#9ca3af' }} className="hover:text-white">Resume</a>
            <a href="mailto:joannzhang4@gmail.com" style={{ fontSize: '14px', lineHeight: '18px', color: '#9ca3af' }} className="hover:text-white" target="_blank" rel="noopener noreferrer">Contact</a>
          </div>
        </nav>
      </div>

      {/* Hero */}
      <div className="page-hero" style={{ paddingTop: '120px', paddingBottom: '0px', display: 'flex', justifyContent: 'center', alignItems: 'flex-end', overflow: 'hidden', paddingLeft: '80px', paddingRight: '80px' }}>
        <Image
        ...
        <div className="content-wide overview-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '80px', alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div>
              ...
              <p style={{ fontSize: '20px', lineHeight: '28px', color: '#9ca3af', maxWidth: '520px' }}>
                Help independent landlords manage their rental properties
              </p>
            </div>
            <div>
              <p className={`section-label ${syne.className}`}>Overview</p>
              <p style={{ fontSize: '17px', lineHeight: '28px', color: '#a1a1aa' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            <div>
              ...
              <p style={{ fontSize: '15px', color: '#a1a1aa', lineHeight: '1.8' }}>Product Designer</p>
            </div>
            <div>
              <p className={`section-label ${syne.className}`}>Project Timeline</p>
              <p style={{ fontSize: '15px', color: '#a1a1aa' }}>November – December 2022</p>
            </div>
            <div>
              <p className={`section-label ${syne.className}`}>Role</p>
              <p style={{ fontSize: '15px', color: '#a1a1aa', lineHeight: '1.8' }}>User Research<br />Prototype<br />Visual Design</p>
            </div>
            <div>
              <p className={`section-label ${syne.className}`}>KPIs</p>
              <p style={{ fontSize: '15px', color: '#a1a1aa', lineHeight: '1.8' }}>+8% YoY Growth<br />12% conversion rate<br />~6% user retention</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#1a1a1a', padding: '80px 40px' }}>
        <div className="content">
          ...
          <h2 style={{ fontSize: '40px', lineHeight: '48px', fontWeight: '400', letterSpacing: '-0.02em', color: '#ffffff', marginBottom: '24px' }}>
            Auditing and organizing the design foundation
          </h2>
          <p style={{ fontSize: '17px', lineHeight: '28px', color: '#a1a1aa', marginBottom: '24px' }}>
      ...
      <section style={{ padding: '80px 40px' }}>
        <div className="content">
          ...
          <p style={{ fontSize: '17px', lineHeight: '28px', color: '#a1a1aa', marginBottom: '48px' }}>
          ...
          <div className="img-placeholder" style={{ minHeight: '320px', marginBottom: '16px' }}>
            [ Image: Design system overview — UI components, buttons, inputs, modals, icons ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center', marginBottom: '48px' }}>
          ...
          <div className="img-placeholder" style={{ minHeight: '280px', marginBottom: '16px' }}>
            [ Image: Button components — default, disabled, focused states and variants ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center', marginBottom: '48px' }}>
          ...
          <div className="img-placeholder" style={{ minHeight: '280px', marginBottom: '16px' }}>
            [ Image: Input fields — spacing, text hierarchy, contrast, validation states ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center', marginBottom: '48px' }}>
          ...
          <div className="img-placeholder" style={{ minHeight: '280px', marginBottom: '16px' }}>
            [ Image: List-based components — payment methods, contacts, checkboxes, radio buttons ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center' }}>
      ...
      <section style={{ backgroundColor: '#1a1a1a', padding: '80px 40px' }}>
        <div className="content">
          ...
          <p style={{ fontSize: '17px', lineHeight: '28px', color: '#a1a1aa', marginBottom: '32px' }}>
      ...
      {/* Footer */}
      <footer style={{ padding: '40px 40px', borderTop: '1px solid #2a2a2a' }}>
        <div style={{ maxWidth: '1920px', margin: '0 auto' }}>
          ...
          <div className="flex gap-4" style={{ marginBottom: '24px' }}>
            <a href="mailto:joannzhang4@gmail.com" style={{ fontSize: '14px', color: '#9ca3af' }} className="hover:text-white">Email ↗</a>
            <a href="https://drive.google.com/file/d/10qr8SW-5Bl4sMWUW6xxBK6LH0Zkw3B1w/view?usp=sharing" target="_blank" rel="noopener noreferrer" style={{ fontSize: '14px', color: '#9ca3af' }} className="hover:text-white">Resume ↗</a>
          </div>
