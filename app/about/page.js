    ...
    <main className="about-main min-h-screen" style={{ paddingLeft: '80px', paddingRight: '80px', backgroundColor: '#fbfbfb' }}>
      ...
      <div className="flex flex-col items-center" style={{ paddingTop: '60px', paddingBottom: '120px' }}>
        ...
        <div className="about-photo-wrap" style={{ position: 'relative', width: '320px', height: '380px', marginBottom: '32px', flexShrink: 0, paddingBottom: '24px' }}>
          ...
          <div className="shape" style={{ top: '55px', left: '28px', width: '24px', height: '24px', borderRadius: '50%', backgroundColor: '#2dd4bf', animation: 'aboutOrbitCW 5s ease-in-out infinite' }} />

          {/* Blue square — upper center-left */}
          <div className="shape" style={{ top: '15px', left: '118px', width: '24px', height: '24px', borderRadius: '4px', backgroundColor: '#3b82f6', animation: 'aboutOrbitCCW 7s ease-in-out infinite' }} />

          {/* Blue circle — upper center-right */}
          <div className="shape" style={{ top: '18px', left: '204px', width: '24px', height: '24px', borderRadius: '50%', backgroundColor: '#3b82f6', animation: 'aboutOrbitSm 6s ease-in-out infinite' }} />

          {/* Green right-pointing triangle — top right */}
          <svg className="shape" style={{ top: '53px', left: '262px', animation: 'aboutOrbitCW 8s ease-in-out infinite' }} width="24" height="24" viewBox="0 0 100 100">
            <path d="M 0 0 L 100 50 L 0 100 Z" fill="#22c55e"/>
          </svg>

          {/* Green organic star — center */}
          <svg className="shape" style={{ top: '65px', left: '132px', animation: 'aboutOrbitCCW 9s ease-in-out infinite' }} width="24" height="24" viewBox="0 0 189 181">
          ...
          <svg className="shape" style={{ top: '80px', left: '76px', animation: 'aboutOrbitSm 6.5s ease-in-out infinite' }} width="24" height="24" viewBox="0 0 100 100">
            <path d="M 0 0 L 100 50 L 0 100 Z" fill="#818cf8"/>
          </svg>

          {/* Red dot — right of center */}
          <div className="shape" style={{ top: '72px', left: '200px', width: '24px', height: '24px', borderRadius: '50%', backgroundColor: '#ef4444', animation: 'aboutOrbitCW 7.5s ease-in-out infinite' }} />

          {/* Pink organic star — right */}
          <svg className="shape" style={{ top: '90px', left: '250px', animation: 'aboutOrbitCCW 5.5s ease-in-out infinite' }} width="24" height="24" viewBox="0 0 189 181">
          ...
          <svg className="shape" style={{ top: '110px', left: '16px', animation: 'aboutOrbitCW 6s ease-in-out infinite' }} width="24" height="24" viewBox="0 0 189 181">
