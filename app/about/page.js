    ...
    <main className="min-h-screen bg-white" style={{ paddingLeft: '80px', paddingRight: '80px' }}>
      ...
      <div className="flex flex-col items-center" style={{ paddingTop: '60px', paddingBottom: '120px' }}>
        ...
        <div style={{ position: 'relative', width: '320px', height: '380px', marginBottom: '32px', flexShrink: 0 }}>
          ...
          {/* Green circle — left */}
          <div className="shape" style={{ top: '62px', left: '18px', width: '26px', height: '26px', borderRadius: '50%', backgroundColor: '#22c55e' }} />

          {/* Orange organic star — upper left */}
          <svg className="shape" style={{ top: '16px', left: '72px' }} width="38" height="36" viewBox="0 0 189 181">
          ...
          {/* Blue organic star — top center */}
          <svg className="shape" style={{ top: '4px', left: '138px' }} width="44" height="42" viewBox="0 0 189 181">
          ...
          {/* Purple sharp triangle — left */}
          <svg className="shape" style={{ top: '98px', left: '28px' }} width="30" height="30" viewBox="0 0 100 100">
            <path d="M 0 0 L 100 50 L 0 100 Z" fill="#818cf8"/>
          </svg>

          {/* Pink organic star — upper right */}
          <svg className="shape" style={{ top: '32px', right: '32px' }} width="36" height="34" viewBox="0 0 189 181">
          ...
          {/* Green sharp triangle — top right */}
          <svg className="shape" style={{ top: '14px', right: '12px' }} width="30" height="30" viewBox="0 0 100 100">
            <path d="M 100 0 L 0 50 L 100 100 Z" fill="#22c55e"/>
          </svg>

          {/* Red circle — right */}
          <div className="shape" style={{ top: '90px', right: '24px', width: '16px', height: '16px', borderRadius: '50%', backgroundColor: '#ef4444' }} />
        </div>
