    ...
    <main className="min-h-screen bg-white" style={{ paddingLeft: '80px', paddingRight: '80px' }}>
      ...
      <div className="flex flex-col items-center" style={{ paddingTop: '60px', paddingBottom: '120px' }}>
        ...
        <div style={{ position: 'relative', width: '320px', height: '380px', marginBottom: '32px', flexShrink: 0, paddingBottom: '24px' }}>
          ...
          <svg className="shape" style={{ top: '95px', left: '134px' }} width="24" height="24" viewBox="0 0 189 181">
          ...
          <svg className="shape" style={{ top: '115px', left: '88px' }} width="24" height="24" viewBox="0 0 100 100">
            <path d="M 0 0 L 100 50 L 0 100 Z" fill="#818cf8"/>
          </svg>

          {/* Red dot — right of center */}
          <div className="shape" style={{ top: '111px', left: '198px', width: '24px', height: '24px', borderRadius: '50%', backgroundColor: '#ef4444' }} />

          {/* Pink organic star — right */}
          <svg className="shape" style={{ top: '127px', left: '242px' }} width="24" height="24" viewBox="0 0 189 181">
          ...
          <svg className="shape" style={{ top: '140px', left: '24px' }} width="24" height="24" viewBox="0 0 189 181">
