    ...
    <main className="min-h-screen bg-white" style={{ paddingLeft: '80px', paddingRight: '80px' }}>
      ...
      <div className="flex flex-col items-center" style={{ paddingTop: '60px', paddingBottom: '120px' }}>
        ...
        <div style={{ position: 'relative', width: '320px', height: '380px', marginBottom: '32px', flexShrink: 0 }}>
          ...
          <div className="shape" style={{ top: '55px', left: '28px', width: '34px', height: '34px', borderRadius: '50%', backgroundColor: '#2dd4bf' }} />

          {/* Blue square — upper center-left */}
          <div className="shape" style={{ top: '15px', left: '118px', width: '26px', height: '26px', borderRadius: '4px', backgroundColor: '#3b82f6' }} />

          {/* Blue circle — upper center-right */}
          <div className="shape" style={{ top: '18px', left: '204px', width: '26px', height: '26px', borderRadius: '50%', backgroundColor: '#3b82f6' }} />

          {/* Green right-pointing triangle — top right */}
          <svg className="shape" style={{ top: '53px', left: '262px' }} width="26" height="26" viewBox="0 0 100 100">
            <path d="M 0 0 L 100 50 L 0 100 Z" fill="#22c55e"/>
          </svg>

          {/* Green organic star — center */}
          <svg className="shape" style={{ top: '95px', left: '134px' }} width="18" height="17" viewBox="0 0 189 181">
          ...
          <svg className="shape" style={{ top: '115px', left: '88px' }} width="14" height="14" viewBox="0 0 100 100">
            <path d="M 0 0 L 100 50 L 0 100 Z" fill="#818cf8"/>
          </svg>

          {/* Red dot — right of center */}
          <div className="shape" style={{ top: '111px', left: '198px', width: '12px', height: '12px', borderRadius: '50%', backgroundColor: '#ef4444' }} />

          {/* Pink organic star — right */}
          <svg className="shape" style={{ top: '127px', left: '242px' }} width="16" height="15" viewBox="0 0 189 181">
          ...
          <svg className="shape" style={{ top: '140px', left: '24px' }} width="22" height="21" viewBox="0 0 189 181">
