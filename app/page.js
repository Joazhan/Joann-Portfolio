  ...
  return (
    ...
    <main className="min-h-screen portfolio-main" style={{ paddingLeft: '80px', paddingRight: '80px', cursor: 'none', backgroundColor: '#fbfbfb' }}>
      <style>{`
        ...
        .hero-shape-green-tri   { filter: drop-shadow(0 0 18px rgba(34,197,94,0.65)); }
        .hero-shape-orange-star { filter: drop-shadow(0 0 18px rgba(249,115,22,0.65)); }
        .hero-shape-green-circle{ filter: drop-shadow(0 0 18px rgba(34,197,94,0.65)); }
        .hero-shape-purple-tri  { filter: drop-shadow(0 0 18px rgba(129,140,248,0.65)); }
        .hero-shape-pink-star   { filter: drop-shadow(0 0 18px rgba(244,114,182,0.65)); }
        .hero-shape-blue-star   { filter: drop-shadow(0 0 18px rgba(59,130,246,0.65)); }
      ...
      <section ref={heroRef} className="hero-section" style={{ position: 'relative', zIndex: 0, margin: '0 -80px', padding: '120px 80px 60px' }}>
        ...
        <div className={introComplete ? 'hero-in' : 'hero-pre'} style={{ position: 'absolute', inset: 0, pointerEvents: 'none', animationDelay: '0.4s', zIndex: 0 }}>
          ...
          <svg data-parallax="0.42" className="hero-shape hero-shape-orange-star" style={{ position: 'absolute', top: '8px', left: '42%', pointerEvents: 'none' }} width="52" height="50" viewBox="0 0 189 181">
          ...
          <div data-parallax="0.18" className="hero-shape hero-shape-green-circle" style={{ position: 'absolute', top: '5px', right: '13%', width: '40px', height: '40px', borderRadius: '50%', backgroundColor: '#22c55e', pointerEvents: 'none' }} />
          ...
          <svg data-parallax="0.36" className="hero-shape hero-shape-pink-star" style={{ position: 'absolute', bottom: '0px', left: '6%', pointerEvents: 'none' }} width="96" height="92" viewBox="0 0 189 181">
