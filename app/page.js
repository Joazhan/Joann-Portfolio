...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      updateHeroShapes(currentScrollY)
      // NN card parallax
    ...
    const handleMouseMove = (e) => {
      ...
      updateHeroShapes(window.scrollY)
    }

    const handleMouseLeave = () => {
      // Smoothly return to center on leave
      heroMouse.current = {
        x: heroRef.current ? heroRef.current.offsetWidth / 2 : 0,
        y: heroRef.current ? heroRef.current.offsetHeight / 2 : 0,
      }
      updateHeroShapes(window.scrollY)
    }
  ...
  return (
    ...
    <main className="min-h-screen portfolio-main" style={{ paddingLeft: '80px', paddingRight: '80px', cursor: 'none', backgroundColor: '#fbfbfb' }}>
      <style>{`
        ...
        @media (max-width: 767px) {
          * { cursor: auto !important; }
          ...
          .hero-shape-visible { transition: transform 0.12s ease-out; }
      ...
      <section ref={heroRef} className="hero-section" style={{ position: 'relative', zIndex: 0, overflow: 'hidden', margin: '0 -80px', padding: '120px 80px 60px' }}>
        ...
        <svg data-parallax="0.28" className="hero-shape hero-shape-visible" style={{ position: 'absolute', top: '12%', left: '3.5%', pointerEvents: 'none' }} width="100" height="100" viewBox="0 0 100 100">
          <path d="M 0 0 L 100 50 L 0 100 Z" fill="#22c55e"/>
        </svg>
        {/* Orange organic star — top center */}
        <svg data-parallax="0.42" className="hero-shape hero-shape-visible" style={{ position: 'absolute', top: '8px', left: '42%', pointerEvents: 'none' }} width="90" height="86" viewBox="0 0 189 181">
        ...
        <div data-parallax="0.18" className="hero-shape hero-shape-visible" style={{ position: 'absolute', top: '5px', right: '13%', width: '68px', height: '68px', borderRadius: '50%', backgroundColor: '#22c55e', pointerEvents: 'none' }} />
        {/* Red circle — far right edge */}
        <div data-parallax="0.32" className="hero-shape hero-shape-visible" style={{ position: 'absolute', top: '30%', right: '0px', width: '54px', height: '54px', borderRadius: '50%', backgroundColor: '#ef4444', pointerEvents: 'none' }} />
        {/* Purple sharp triangle — lower right */}
        <svg data-parallax="0.22" className="hero-shape hero-shape-visible" style={{ position: 'absolute', bottom: '8%', right: '5%', pointerEvents: 'none' }} width="88" height="88" viewBox="0 0 100 100">
          <path d="M 0 0 L 100 50 L 0 100 Z" fill="#818cf8"/>
        </svg>
        {/* Pink organic star — bottom left */}
        <svg data-parallax="0.36" className="hero-shape hero-shape-visible" style={{ position: 'absolute', bottom: '0px', left: '6%', pointerEvents: 'none' }} width="96" height="92" viewBox="0 0 189 181">
        ...
        <svg data-parallax="0.38" className="hero-shape hero-shape-visible" style={{ position: 'absolute', bottom: '0px', left: '57%', pointerEvents: 'none' }} width="68" height="65" viewBox="0 0 189 181">
