...
.card-title { font-size: 20px !important; line-height: 26px !important; letter-spacing: -0.03em !important; }
      ...
      <section ref={heroRef} className="hero-section" style={{ position: 'relative', zIndex: 0, margin: '0 -64px', padding: '120px 64px 60px' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
          {/* ── LEFT SIDE ── */}
          {/* Green sharp triangle */}
          <div data-parallax="0.28" className={`hero-shape hero-shape-green-tri ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '15px', left: '2%', pointerEvents: 'none', animationDelay: '0.55s' }}>
          ...
          {/* Orange organic star */}
          <div data-parallax="0.42" className={`hero-shape hero-shape-orange-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '210px', left: '4%', pointerEvents: 'none', animationDelay: '0.7s' }}>
          ...
          {/* Pink organic star */}
          <div data-parallax="0.36" className={`hero-shape hero-shape-pink-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '365px', left: '1%', pointerEvents: 'none', animationDelay: '1.2s' }}>
          ...
          {/* ── RIGHT SIDE ── */}
          {/* Green circle */}
          <div data-parallax="0.18" className={`hero-shape hero-shape-green-circle ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '15px', right: '3%', pointerEvents: 'none', animationDelay: '0.85s' }}>
            <div style={{ width: '72px', height: '72px', borderRadius: '50%', backgroundColor: '#22c55e', animation: 'orbitSm 5s ease-in-out infinite' }} />
          </div>
          {/* Red circle */}
          <div data-parallax="0.32" className={`hero-shape hero-shape-red-circle ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '115px', right: '5%', pointerEvents: 'none', animationDelay: '1.0s' }}>
            <div style={{ width: '110px', height: '110px', borderRadius: '50%', backgroundColor: '#ef4444', animation: 'orbitCW 4s ease-in-out infinite' }} />
          </div>
          {/* Purple sharp triangle */}
          <div data-parallax="0.22" className={`hero-shape hero-shape-purple-tri ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '255px', right: '1%', pointerEvents: 'none', animationDelay: '1.1s' }}>
          ...
          {/* Blue organic star */}
          <div data-parallax="0.38" className={`hero-shape hero-shape-blue-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '435px', right: '2%', pointerEvents: 'none', animationDelay: '1.35s' }}>
