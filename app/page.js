...
.card-title { font-size: 20px !important; line-height: 26px !important; letter-spacing: -0.03em !important; }
      ...
      <section ref={heroRef} className="hero-section" style={{ position: 'relative', zIndex: 0, margin: '0 -64px', padding: '120px 64px 60px' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
          {/* ── LEFT SIDE ── */}
          {/* Green sharp triangle — upper left */}
          <div data-parallax="0.28" className={`hero-shape hero-shape-green-tri ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '8%', left: '2%', pointerEvents: 'none', animationDelay: '0.55s' }}>
            <svg width="160" height="160" viewBox="0 0 100 100" style={{ animation: 'orbitCW 6s ease-in-out infinite' }}>
              <path d="M 100 0 L 0 50 L 100 100 Z" fill="#22c55e"/>
            </svg>
          </div>
          {/* Orange organic star — mid left */}
          <div data-parallax="0.42" className={`hero-shape hero-shape-orange-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '44%', left: '1%', pointerEvents: 'none', animationDelay: '0.7s' }}>
            <svg width="120" height="115" viewBox="0 0 189 181" style={{ animation: 'orbitCCW 8s ease-in-out infinite' }}>
          ...
          <div data-parallax="0.36" className={`hero-shape hero-shape-pink-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', bottom: '0px', left: '1.5%', pointerEvents: 'none', animationDelay: '1.2s' }}>
            <svg width="160" height="153" viewBox="0 0 189 181" style={{ animation: 'orbitCW 9s ease-in-out infinite' }}>
          ...
          <div data-parallax="0.18" className={`hero-shape hero-shape-green-circle ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '6%', right: '2%', pointerEvents: 'none', animationDelay: '0.85s' }}>
            <div style={{ width: '72px', height: '72px', borderRadius: '50%', backgroundColor: '#22c55e', animation: 'orbitSm 5s ease-in-out infinite' }} />
          </div>
          {/* Red circle — mid right */}
          <div data-parallax="0.32" className={`hero-shape hero-shape-red-circle ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '36%', right: '1.5%', pointerEvents: 'none', animationDelay: '1.0s' }}>
            <div style={{ width: '110px', height: '110px', borderRadius: '50%', backgroundColor: '#ef4444', animation: 'orbitCW 4s ease-in-out infinite' }} />
          </div>
          {/* Purple sharp triangle — lower right */}
          <div data-parallax="0.22" className={`hero-shape hero-shape-purple-tri ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', bottom: '8%', right: '1.5%', pointerEvents: 'none', animationDelay: '1.1s' }}>
            <svg width="150" height="150" viewBox="0 0 100 100" style={{ animation: 'orbitCCW 7s ease-in-out infinite' }}>
              <path d="M 0 0 L 100 50 L 0 100 Z" fill="#818cf8"/>
            </svg>
          </div>
          {/* Blue organic star — bottom right */}
          <div data-parallax="0.38" className={`hero-shape hero-shape-blue-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', bottom: '0px', right: '1.5%', pointerEvents: 'none', animationDelay: '1.35s' }}>
            <svg width="175" height="168" viewBox="0 0 189 181" style={{ animation: 'orbitSm 6.5s ease-in-out infinite' }}>
