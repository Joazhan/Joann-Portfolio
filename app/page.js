  ...
  return (
    ...
    <main className="min-h-screen portfolio-main" style={{ paddingLeft: '64px', paddingRight: '64px', cursor: 'none', backgroundColor: '#fbfbfb' }}>
      <style>{`
        ...
        .card-title { font-size: 24px !important; line-height: 32px !important; letter-spacing: -0.03em !important; }
...
.card-title { font-size: 20px !important; line-height: 26px !important; letter-spacing: -0.03em !important; }
      ...
      <section ref={heroRef} className="hero-section" style={{ position: 'relative', zIndex: 0, margin: '0 -64px', padding: '120px 64px 60px' }}>
        ...
        <div className={introComplete ? 'hero-in' : 'hero-pre'} style={{ position: 'absolute', inset: 0, pointerEvents: 'none', animationDelay: '0.4s', zIndex: 0 }}>
          ...
          <div data-parallax="0.28" className="hero-shape hero-shape-green-tri" style={{ position: 'absolute', top: '12%', left: '3.5%', pointerEvents: 'none' }}>
            <svg width="100" height="100" viewBox="0 0 100 100" style={{ animation: 'orbitCW 6s ease-in-out infinite' }}>
              <path d="M 100 0 L 0 50 L 100 100 Z" fill="#22c55e"/>
            </svg>
          </div>
          {/* Orange organic star — top center */}
          <div data-parallax="0.42" className="hero-shape hero-shape-orange-star" style={{ position: 'absolute', top: '8px', left: '42%', pointerEvents: 'none' }}>
          <svg width="52" height="50" viewBox="0 0 189 181" style={{ animation: 'orbitCCW 8s ease-in-out infinite' }}>
          ...
          <div data-parallax="0.36" className="hero-shape hero-shape-pink-star" style={{ position: 'absolute', bottom: '0px', left: '6%', pointerEvents: 'none' }}>
            <svg width="96" height="92" viewBox="0 0 189 181" style={{ animation: 'orbitCW 9s ease-in-out infinite' }}>
          ...
          <div data-parallax="0.38" className="hero-shape hero-shape-blue-star" style={{ position: 'absolute', bottom: '0px', left: '57%', pointerEvents: 'none' }}>
            <svg width="110" height="105" viewBox="0 0 189 181" style={{ animation: 'orbitSm 6.5s ease-in-out infinite' }}>
          ...
          <div className="flex items-center justify-between card-label-row" style={{ padding: '12px 0 0' }}>
            <div className="flex items-center gap-4 card-icon-wrap">
              ...
              <div className="flex flex-col gap-1">
                <span className="card-title" style={{ fontSize: '24px', lineHeight: '32px', letterSpacing: '-0.03em', fontWeight: '500', color: '#212121' }}>NutritionNest</span>
        ...
        <div className="group" style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="flex items-center justify-between card-label-row" style={{ padding: '12px 0 0' }}>
            <div className="flex items-center gap-4 card-icon-wrap">
              ...
              <div className="flex flex-col gap-1">
                <span className="card-title" style={{ fontSize: '24px', lineHeight: '32px', letterSpacing: '-0.03em', fontWeight: '500', color: '#212121' }}>Duetti</span>
        ...
        <div className="group" style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="flex items-center justify-between card-label-row" style={{ padding: '12px 0 0' }}>
            <div className="flex items-center gap-4 card-icon-wrap">
              ...
              <div className="flex flex-col gap-1">
                <span className="card-title" style={{ fontSize: '24px', lineHeight: '32px', letterSpacing: '-0.03em', fontWeight: '500', color: '#212121' }}>Lasertaz</span>
        ...
        <div className="group" style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="flex items-center justify-between card-label-row" style={{ padding: '12px 0 0' }}>
            <div className="flex items-center gap-4 card-icon-wrap">
              ...
              <div className="flex flex-col gap-1">
                <span className="card-title" style={{ fontSize: '24px', lineHeight: '32px', letterSpacing: '-0.03em', fontWeight: '500', color: '#212121' }}>Bookworm</span>
        ...
        <div className="group" style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="flex items-center justify-between card-label-row" style={{ padding: '12px 0 0' }}>
            <div className="flex items-center gap-4 card-icon-wrap">
              ...
              <div className="flex flex-col gap-1">
                <span className="card-title" style={{ fontSize: '24px', lineHeight: '32px', letterSpacing: '-0.03em', fontWeight: '500', color: '#212121' }}>Raymond Hair Salon</span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
          ...
          <div className="flex items-center justify-between card-label-row">
              <div className="flex items-center gap-4 card-icon-wrap">
                ...
                <div className="flex flex-col gap-1">
                  <span className="card-title" style={{ fontSize: '24px', lineHeight: '32px', letterSpacing: '-0.03em', fontWeight: '500', color: '#212121' }}>Kalshi</span>
          ...
          <div className="flex items-center justify-between card-label-row">
              <div className="flex items-center gap-4 card-icon-wrap">
                ...
                <div className="flex flex-col gap-1">
                  <span className="card-title" style={{ fontSize: '24px', lineHeight: '32px', letterSpacing: '-0.03em', fontWeight: '500', color: '#212121' }}>Phia</span>
