...
.card-title { font-size: 20px !important; line-height: 26px !important; letter-spacing: -0.03em !important; }
      ...
      <section ref={heroRef} className="hero-section" style={{ position: 'relative', zIndex: 0, margin: '0 -64px', padding: '120px 64px 60px' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
          ...
          <div data-parallax="0.28" className={`hero-shape hero-shape-green-tri ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '12%', left: '3.5%', pointerEvents: 'none', animationDelay: '0.55s', filter: 'drop-shadow(0 3px 10px rgba(0,0,0,0.12))' }}>
          ...
          <div data-parallax="0.42" className={`hero-shape hero-shape-orange-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '8px', left: '42%', pointerEvents: 'none', animationDelay: '0.7s', filter: 'drop-shadow(0 3px 10px rgba(0,0,0,0.12))' }}>
          ...
          <div data-parallax="0.18" className={`hero-shape hero-shape-green-circle ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '5px', right: '13%', pointerEvents: 'none', animationDelay: '0.85s', filter: 'drop-shadow(0 3px 10px rgba(0,0,0,0.12))' }}>
          ...
          <div data-parallax="0.32" className={`hero-shape hero-shape-red-circle ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', top: '30%', right: '60px', pointerEvents: 'none', animationDelay: '1.0s', filter: 'drop-shadow(0 3px 10px rgba(0,0,0,0.12))' }}>
          ...
          <div data-parallax="0.22" className={`hero-shape hero-shape-purple-tri ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', bottom: '8%', right: '12%', pointerEvents: 'none', animationDelay: '1.1s', filter: 'drop-shadow(0 3px 10px rgba(0,0,0,0.12))' }}>
          ...
          <div data-parallax="0.36" className={`hero-shape hero-shape-pink-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', bottom: '0px', left: '6%', pointerEvents: 'none', animationDelay: '1.2s', filter: 'drop-shadow(0 3px 10px rgba(0,0,0,0.12))' }}>
          ...
          <div data-parallax="0.38" className={`hero-shape hero-shape-blue-star ${introComplete ? 'shape-in' : 'shape-pre'}`} style={{ position: 'absolute', bottom: '0px', left: '57%', pointerEvents: 'none', animationDelay: '1.35s', filter: 'drop-shadow(0 3px 10px rgba(0,0,0,0.12))' }}>
