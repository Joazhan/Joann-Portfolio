...
// 28 shapes, 80-95px wide, 65px spacing = ~20px overlap each pair
const INITIAL_SHAPES = [
  { id: 1,  type: 'triangle', color: '#22c55e', w: 90,  h: 90,  x: 0,    y: 490, r: -12 },
  { id: 2,  type: 'star',     color: '#f97316', w: 85,  h: 81,  x: 65,   y: 482, r: 8   },
  { id: 3,  type: 'circle',   color: '#3b82f6', w: 92,  h: 92,  x: 130,  y: 492, r: 0   },
  { id: 4,  type: 'triangle', color: '#818cf8', w: 88,  h: 88,  x: 195,  y: 480, r: 20  },
  { id: 5,  type: 'star',     color: '#ef4444', w: 84,  h: 80,  x: 260,  y: 486, r: -10 },
  { id: 6,  type: 'circle',   color: '#facc15', w: 90,  h: 90,  x: 325,  y: 494, r: 0   },
  { id: 7,  type: 'triangle', color: '#f472b6', w: 86,  h: 86,  x: 390,  y: 480, r: -18 },
  { id: 8,  type: 'star',     color: '#facc15', w: 88,  h: 84,  x: 455,  y: 488, r: 14  },
  { id: 9,  type: 'circle',   color: '#f97316', w: 92,  h: 92,  x: 520,  y: 492, r: 0   },
  { id: 10, type: 'triangle', color: '#2dd4bf', w: 84,  h: 84,  x: 585,  y: 482, r: 10  },
  { id: 11, type: 'star',     color: '#818cf8', w: 88,  h: 84,  x: 650,  y: 486, r: -8  },
  { id: 12, type: 'circle',   color: '#f472b6', w: 90,  h: 90,  x: 715,  y: 494, r: 0   },
  { id: 13, type: 'triangle', color: '#22c55e', w: 86,  h: 86,  x: 780,  y: 480, r: 16  },
  { id: 14, type: 'star',     color: '#ef4444', w: 84,  h: 80,  x: 845,  y: 488, r: -14 },
  { id: 15, type: 'circle',   color: '#22c55e', w: 92,  h: 92,  x: 910,  y: 492, r: 0   },
  { id: 16, type: 'triangle', color: '#f97316', w: 88,  h: 88,  x: 975,  y: 480, r: -6  },
  { id: 17, type: 'star',     color: '#3b82f6', w: 86,  h: 82,  x: 1040, y: 486, r: 12  },
  { id: 18, type: 'circle',   color: '#818cf8', w: 90,  h: 90,  x: 1105, y: 494, r: 0   },
  { id: 19, type: 'triangle', color: '#facc15', w: 84,  h: 84,  x: 1170, y: 480, r: -20 },
  { id: 20, type: 'star',     color: '#f472b6', w: 88,  h: 84,  x: 1235, y: 486, r: 6   },
  { id: 21, type: 'circle',   color: '#ef4444', w: 92,  h: 92,  x: 1300, y: 492, r: 0   },
  { id: 22, type: 'triangle', color: '#2dd4bf', w: 86,  h: 86,  x: 1365, y: 480, r: 22  },
  { id: 23, type: 'star',     color: '#22c55e', w: 84,  h: 80,  x: 1430, y: 488, r: -10 },
  { id: 24, type: 'circle',   color: '#f97316', w: 90,  h: 90,  x: 1495, y: 494, r: 0   },
  { id: 25, type: 'triangle', color: '#818cf8', w: 88,  h: 88,  x: 1560, y: 480, r: -16 },
  { id: 26, type: 'star',     color: '#facc15', w: 86,  h: 82,  x: 1625, y: 486, r: 8   },
  { id: 27, type: 'circle',   color: '#3b82f6', w: 92,  h: 92,  x: 1690, y: 492, r: 0   },
  { id: 28, type: 'triangle', color: '#f472b6', w: 88,  h: 88,  x: 1755, y: 480, r: -4  },
  { id: 29, type: 'star',     color: '#ef4444', w: 84,  h: 80,  x: 1820, y: 488, r: 18  },
]
