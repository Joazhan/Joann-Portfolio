...
const INITIAL_SHAPES = [
  ...
  // ── Grey horizontal rows at 20px spacing (30 rows, slightly tighter) ──
  ...[...Array(30)].flatMap((_, r) => [...Array(68)].map((_, c) => ({
    id: 1000 + r * 68 + c,
    x: (c + 1) * G - 2,
    y: (r + 1) * 20 - 2,
    w: 4, h: 4,
  ...
  // ── Grey vertical columns at 20px spacing (30 tall) ──
  ...[...Array(30)].map((_, i) => d(3000 + i, 12, i + 1, 8, 4)),
  ...[...Array(30)].map((_, i) => d(3030 + i, 28, i + 1, 8, 4)),
  ...[...Array(30)].map((_, i) => d(3060 + i, 46, i + 1, 8, 4)),
  ...[...Array(30)].map((_, i) => d(3090 + i, 62, i + 1, 8, 4)),
]
