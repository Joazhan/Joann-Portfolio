...
// shapes tumbled to the bottom — irregular x gaps, varied y (some higher, some on the floor), wild rotations
const INITIAL_SHAPES = [
  { id: 1,  type: 'triangle', color: '#22c55e', w: 95,  h: 95,  x: -10,  y: 530, r: -42 },
  { id: 2,  type: 'star',     color: '#f97316', w: 80,  h: 76,  x: 55,   y: 505, r: 27  },
  { id: 3,  type: 'circle',   color: '#3b82f6', w: 88,  h: 88,  x: 105,  y: 545, r: 0   },
  { id: 4,  type: 'triangle', color: '#818cf8', w: 70,  h: 70,  x: 175,  y: 515, r: 55  },
  { id: 5,  type: 'star',     color: '#ef4444', w: 92,  h: 88,  x: 250,  y: 498, r: -18 },
  { id: 6,  type: 'circle',   color: '#facc15', w: 60,  h: 60,  x: 355,  y: 540, r: 0   },
  { id: 7,  type: 'triangle', color: '#f472b6', w: 86,  h: 86,  x: 400,  y: 510, r: -62 },
  { id: 8,  type: 'star',     color: '#2dd4bf', w: 78,  h: 74,  x: 470,  y: 528, r: 35  },
  { id: 9,  type: 'circle',   color: '#f97316', w: 94,  h: 94,  x: 548,  y: 540, r: 0   },
  { id: 10, type: 'triangle', color: '#22c55e', w: 74,  h: 74,  x: 618,  y: 502, r: 48  },
  { id: 11, type: 'star',     color: '#818cf8', w: 90,  h: 86,  x: 700,  y: 518, r: -12 },
  { id: 12, type: 'circle',   color: '#f472b6', w: 64,  h: 64,  x: 795,  y: 548, r: 0   },
  { id: 13, type: 'triangle', color: '#facc15', w: 88,  h: 88,  x: 840,  y: 505, r: -38 },
  { id: 14, type: 'star',     color: '#ef4444', w: 76,  h: 72,  x: 928,  y: 532, r: 22  },
  { id: 15, type: 'circle',   color: '#22c55e', w: 92,  h: 92,  x: 1005, y: 542, r: 0   },
  { id: 16, type: 'triangle', color: '#f97316', w: 82,  h: 82,  x: 1075, y: 508, r: 58  },
  { id: 17, type: 'star',     color: '#3b82f6', w: 68,  h: 64,  x: 1165, y: 525, r: -30 },
  { id: 18, type: 'circle',   color: '#818cf8', w: 90,  h: 90,  x: 1228, y: 544, r: 0   },
  { id: 19, type: 'triangle', color: '#2dd4bf', w: 86,  h: 86,  x: 1300, y: 500, r: -50 },
  { id: 20, type: 'star',     color: '#f472b6', w: 80,  h: 76,  x: 1390, y: 520, r: 16  },
  { id: 21, type: 'circle',   color: '#ef4444', w: 66,  h: 66,  x: 1462, y: 546, r: 0   },
  { id: 22, type: 'triangle', color: '#22c55e', w: 92,  h: 92,  x: 1510, y: 506, r: 44  },
  { id: 23, type: 'star',     color: '#facc15', w: 78,  h: 74,  x: 1610, y: 528, r: -24 },
  { id: 24, type: 'circle',   color: '#f97316', w: 88,  h: 88,  x: 1682, y: 540, r: 0   },
  { id: 25, type: 'triangle', color: '#818cf8', w: 72,  h: 72,  x: 1752, y: 510, r: -60 },
  { id: 26, type: 'star',     color: '#3b82f6', w: 86,  h: 82,  x: 1820, y: 522, r: 32  },
  { id: 27, type: 'circle',   color: '#f472b6', w: 62,  h: 62,  x: 1900, y: 548, r: 0   },
]
