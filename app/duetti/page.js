    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="content-wide" style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '80px', alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div>
              ...
              <a href="https://report.duetti.co/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '15px', color: '#626262', textDecoration: 'none', display: 'inline-block', marginTop: '12px' }} className="hover:text-black">View 2023 economic report ↗</a>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            <div>
              ...
              <p style={{ fontSize: '15px', color: '#626262', lineHeight: '1.8' }}>Product Designer (Me)<br />Lead Product Designer<br />General Manager<br />Engineer</p>
            </div>
            <div>
              <p className={`section-label ${syne.className}`}>Project Timeline</p>
              <p style={{ fontSize: '15px', color: '#626262' }}>December 2024 – January 2025<br />(2 months)</p>
            </div>
            <div>
              <p className={`section-label ${syne.className}`}>Outcomes</p>
              <p style={{ fontSize: '15px', color: '#626262', lineHeight: '1.8' }}>~7%+ artist traffic boost<br />~3% artist conversion rate</p>
            </div>
            <div>
      ...
      <section style={{ padding: '0 40px 80px', borderBottom: '1px solid #e5e7eb' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          <div className="img-placeholder" style={{ minHeight: '320px' }}>
            [ Image: Duetti's 2023 economic report screenshots — 6 slides grid ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center', marginTop: '16px' }}>
      ...
      <section style={{ padding: '80px 40px' }}>
        <div className="content">
          ...
          <div className="img-placeholder" style={{ minHeight: '360px', marginBottom: '16px' }}>
            [ Image: Duetti social media branding covers — 2-row grid ]
          </div>
      ...
      <section style={{ backgroundColor: '#f9fafb', padding: '80px 40px' }}>
        <div className="content">
          ...
          <div className="img-placeholder" style={{ minHeight: '360px', marginBottom: '16px' }}>
            [ Image: Wireframes grid — desktop and mobile pairs per slide ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center' }}>
      ...
      <section style={{ padding: '80px 40px' }}>
        <div className="content">
          ...
          <div className="img-placeholder" style={{ minHeight: '360px', marginBottom: '16px' }}>
            [ Image: Mid-fidelity overview grid — lime green, yellow, pink, purple rows ]
          </div>
          ...
          <div className="img-placeholder" style={{ minHeight: '280px', marginBottom: '16px' }}>
            [ Image: Mid-fi yellow genre chart — "Breaking Down Wallet Share By Genre Platform" ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center', marginBottom: '48px' }}>
          ...
          <div className="img-placeholder" style={{ minHeight: '280px', marginBottom: '16px' }}>
            [ Image: Mid-fi pink slide — country genre data with lime green bar chart ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center' }}>
      ...
      <section style={{ backgroundColor: '#f9fafb', padding: '80px 40px' }}>
        <div className="content">
          ...
          <div className="img-placeholder" style={{ minHeight: '400px', marginBottom: '16px' }}>
            [ Image: Final design grid — green, purple, wine-red, yellow tones ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center', marginBottom: '48px' }}>
          ...
          <div className="img-placeholder" style={{ minHeight: '280px', marginBottom: '16px' }}>
            [ Image: Spotify Discovery Mode chart — dark green background, yellow line graph ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center', marginBottom: '48px' }}>
          ...
          <div className="img-placeholder" style={{ minHeight: '280px', marginBottom: '16px' }}>
            [ Image: Spotify Consumer Prices vs. Payout Rates — dual line chart ]
          </div>
          <p style={{ fontSize: '14px', lineHeight: '24px', color: '#6b7280', fontStyle: 'italic', textAlign: 'center', marginBottom: '48px' }}>
      ...
      <section style={{ padding: '80px 40px' }}>
        <div className="content">
          ...
          <a href="https://report.duetti.co/#1" target="_blank" rel="noopener noreferrer" style={{ fontSize: '17px', fontWeight: '600', color: '#212121', textDecoration: 'none' }} className="hover:underline">
